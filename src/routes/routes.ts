...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/comments',
            ...
            function CommentsController_create(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/comments',
            ...(fetchMiddlewares<RequestHandler>(CommentsController)),
            ...(fetchMiddlewares<RequestHandler>(CommentsController.prototype.findBy)),

            function CommentsController_findBy(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.findBy.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/comments/:id',
            ...(fetchMiddlewares<RequestHandler>(CommentsController)),
            ...(fetchMiddlewares<RequestHandler>(CommentsController.prototype.findById)),

            function CommentsController_findById(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/posts',
            ...
            function PostsController_create(request: any, response: any, next: any) {
            const args = {
                    createPostDto: {"in":"body","name":"createPostDto","required":true,"ref":"CreatePostDto"},
            };
        ...
        app.get('/posts',
            ...(fetchMiddlewares<RequestHandler>(PostsController)),
            ...(fetchMiddlewares<RequestHandler>(PostsController.prototype.findBy)),

            function PostsController_findBy(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/posts/:id',
            ...(fetchMiddlewares<RequestHandler>(PostsController)),
            ...(fetchMiddlewares<RequestHandler>(PostsController.prototype.findById)),

            function PostsController_findById(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        app.post('/users/:id/posts',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.createUserPost)),

            function UsersController_createUserPost(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
                    createPostDto: {"in":"body","name":"createPostDto","required":true,"ref":"CreatePostDto"},
            };
            ...
            try {
              ...
              const promise = controller.createUserPost.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/users',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.findBy)),

            function UsersController_findBy(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/users/:id',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.findById)),

            function UsersController_findById(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        app.get('/users/:id/posts',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.findUserPosts)),

            function UsersController_findUserPosts(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.findUserPosts.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
