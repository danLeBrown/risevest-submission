...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/comments',
            ...(fetchMiddlewares<RequestHandler>(CommentsController)),
            ...(fetchMiddlewares<RequestHandler>(CommentsController.prototype.findAll)),

            function CommentsController_findAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/posts',
            ...(fetchMiddlewares<RequestHandler>(PostsController)),
            ...(fetchMiddlewares<RequestHandler>(PostsController.prototype.findAll)),
        ...
        app.get('/users',
            ...
            function UsersController_findAll(request: any, response: any, next: any) {
            const args = {
            };
